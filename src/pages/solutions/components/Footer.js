...
import footerflower from '../../../assets/images/solutions/blue_dark.png';
...
const Footer = () => {
  return (
    <div
      className={`absolute h-full top-[100%] w-screen overflow-hidden bg-[#262629] ease-in-out duration-[2.5s]`}
    >
