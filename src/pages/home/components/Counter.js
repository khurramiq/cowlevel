  ...
  return (
    <div className="absolute flex justify-center items-center top-[100%] w-screen h-full overflow-hidden bg-[#FFFBE8]">
      <div>
        ...
        <p className="xs:w-[90%] sm:w-full m-auto sm:text-[36px] xs:text-lg md:mt-[50px] xs:mt-5 font-bold text-center xs:leading-[1.16]">
          OVER $200K OF IN-GAME ITEMS <br />
          CHANGE HANDS EVERY MINUTE.
        </p>
        <p className="text-center md:mt-[30px] sm:mt-2 xs:mt-1 font-semibold sm:text-[24px] xs:text-sm">
          HOLY COW!
        </p>
        <p className="xs:w-[90%] sm:w-full m-auto text-center md:mt-[30px] sm:mt-2 xs:mt-1 font-normal sm:text-[18px] xs:text-xs  xs:leading-[1.3]">
